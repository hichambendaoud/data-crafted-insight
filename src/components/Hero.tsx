    ...
    <section id="about" className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center gap-12 min-h-[80vh]">
      ...
      <div className="flex-1 text-center md:text-left animate-fade-in-up">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start mb-8">
          ...
          <a href="hichambendaoud.github.io/public/pdf/CV_Hicham_Ben_Daoud.pdf" target="_blank" rel="noopener noreferrer">
            <Button
              variant="outline"
              size="lg"
        ...
        <div className="flex items-center justify-center md:justify-start space-x-6">
          <a
            href="https://www.linkedin.com/in/hicham-ben-daoud-a40a80240/"
            target="_blank"
          ...
          <a
            href="mailto:hicham.bendaoudofficiel@gmail.com"
            className="text-muted-foreground hover:text-primary transition-all duration-300 hover:scale-110 transform"
          >
